...
// ECDSA key. In production you'd wrap your KMS / HSM here instead. This key
// authorizes ClaimBatch and Refund operations for channels bound to it, so
// controlling it lets the receiver keep its channels across facilitator swaps.
